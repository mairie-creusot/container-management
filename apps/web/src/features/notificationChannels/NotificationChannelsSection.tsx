 ...
 * routé, en tâche de fond, vers chaque canal actif dont le filtre matche.
 *
 * Extrait de NotificationChannelsPage le 24/08/2026 : SEULE source de vérité de ce formulaire,
 * montée par la page Réglages ET par la page conservée dans le menu latéral.
 */
  ...
  return (
    <>
      <div className="page-header" style={{ marginTop: 0 }}>
        <div>
          <h3 style={{ marginBottom: 4 }}>Canaux de notification</h3>
          <p>
            Route les événements système (nouvelle version d'image, intégration injoignable, dérive GitOps,
            vulnérabilité critique — voir Notifications) vers des canaux externes : webhook générique, Slack, Discord
            ou email SMTP.
          </p>
        </div>
        {admin && (
